...
&#x09;\*\* 7.1. Fíjese que ahora está en la sección \*\*Compiler\*\*, dentro de \*\*Search directories\*\*. Haga clic en \*\*Add\*\* y reemplace la ruta que está 	escrita por \*include\*, luego confirme los cambios oprimiendo en \*\*OK\*\*.



&#x09;\*\* 7.2. Ahora, haga clic en \*\*Linker\*\*, que se encuentra al lado de \*\*Compiler\*\*. Haga clic en \*\*Add\*\* y reeemplace todo lo que está escrito por 	\*lib\*, luego confirme los cambios oprimiendo en \*\*OK\*\*.
